...
export const KeyboardShortcutsModal: React.FC<KeyboardShortcutsModalProps> = ({
  ...
  const shortcuts = [
    ...
    { key: 'Ctrl + C', desc: isSpanish ? 'Copiar archivos al portapapeles de Windows' : 'Copy files to the Windows clipboard' },
    { key: 'Ctrl + X', desc: isSpanish ? 'Cortar archivos para moverlos con Pegar' : 'Cut files to move them with Paste' },
